...
# Auto-select compose profile unless explicitly provided.
# Default behavior is GPU when available, otherwise CPU fallback.
...
echo -e "${BLUE}  Compose profile: ${COMPOSE_PROFILES}${NC}"
echo -e "${BLUE}========================================${NC}"

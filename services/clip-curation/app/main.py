...
class ClipCurator:
    ...
    async def start(self):
        ...
        # Subscribe to preprocessed short-video events (fallback to uploaded)
        subjects = self.config.get("nats", {}).get("subjects", {})
        subject = subjects.get("video_preprocessed") or subjects.get("video_uploaded", "video.uploaded")

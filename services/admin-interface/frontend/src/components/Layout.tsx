...
export default function Layout({ children }: LayoutProps) {
  ...
  const navItems = [
    { path: '/', label: 'Dashboard', icon: Home, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/upload', label: 'Upload', icon: Upload, roles: ['admin', 'tenant_admin', 'researcher'] },
    { path: '/raw-videos', label: 'Raw Videos', icon: Film, roles: ['admin', 'tenant_admin', 'researcher', 'viewer'] },
    { path: '/short-videos', label: 'Short Videos', icon: PlayCircle, roles: ['admin', 'tenant_admin', 'researcher', 'viewer'] },
    { path: '/users', label: 'Users', icon: Users, roles: ['admin', 'tenant_admin'] },
    { path: '/videos', label: 'Videos', icon: Video, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/cows', label: 'Cow Registry', icon: Beef, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/pairwise', label: 'Pairwise', icon: GitCompare, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/triplet', label: 'Triplet', icon: Triangle, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/hierarchy', label: 'Hierarchy', icon: Network, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/similarity', label: 'Similarity', icon: Map, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/learn', label: 'Learn', icon: GraduationCap, roles: ['admin', 'tenant_admin', 'researcher', 'viewer', 'rater'] },
    { path: '/pipelines', label: 'Pipelines', icon: Activity, roles: ['admin', 'tenant_admin', 'researcher'] },
    { path: '/health', label: 'Health', icon: Heart, roles: ['admin', 'tenant_admin', 'researcher'] },
    { path: '/training', label: 'Queue', icon: ListTodo, roles: ['admin', 'tenant_admin', 'researcher'] },
    { path: '/config', label: 'ML Config', icon: Cpu, roles: ['admin', 'tenant_admin', 'researcher'] },
